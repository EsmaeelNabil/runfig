 ...
 */
internal class DebugOverlayDependenciesContainer private constructor(
     ...
     * Created lazily when first accessed.
     */
    private val _configRepository by lazy {
        ConfigRepository(application).apply {
            saveConfig(DebugOverlayConfig(longPressDelayMs = 2000))
        }
    }
    ...
    companion object {
         ...
         */
        fun create(application: Application): DebugOverlayDependenciesContainer {
            return DebugOverlayDependenciesContainer(application)
        }
    }
}